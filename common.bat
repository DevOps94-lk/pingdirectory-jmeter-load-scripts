...
REM trustAll is set in the .jmx; also disable JNDI LDAPS hostname verification
REM (fails with certificate_unknown when pd.hostWrite is an LB IP not in the cert SAN).
